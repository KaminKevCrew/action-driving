  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="bg-background-secondary p-8 rounded-lg shadow-lg mb-8">
        <h2 className="text-2xl font-bold mb-4 text-text">Our Training Philosophy</h2>
      ...
      <div className="bg-background-secondary p-8 rounded-lg shadow-lg mb-8">
        <h2 className="text-2xl font-bold mb-4 text-text">Driving Labs</h2>
        <p className="text-text-normal mb-4">
        ...
        <h3 className="text-xl font-semibold mb-2 text-text mt-6">Eligibility Requirements</h3>
        <ul className="list-disc pl-5 text-text-normal mb-4">
      ...
      <div className="bg-background-secondary p-8 rounded-lg shadow-lg">
        <h2 className="text-2xl font-bold mb-4 text-text">Private Coaching & Feedback</h2>
        <p className="text-text-normal mb-4">
