      ...
      <div className="bg-[#2f3136] p-8 rounded-lg shadow-lg mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            ...
            <p className="text-gray-300 mb-1">Email: <a href="mailto:info@actiondriving.com" className="text-blue-400 hover:underline">info@actiondriving.com</a></p>
          </div>
          <div>
            <h3 className="text-xl font-semibold text-white mb-2">Membership</h3>
            <p className="text-gray-300 mb-1">Email: <a href="mailto:membership@actiondriving.com" className="text-blue-400 hover:underline">membership@actiondriving.com</a></p>
          </div>
          <div>
            <h3 className="text-xl font-semibold text-white mb-2">Training Programs</h3>
            <p className="text-gray-300 mb-1">Email: <a href="mailto:training@actiondriving.com" className="text-blue-400 hover:underline">training@actiondriving.com</a></p>
          </div>
          <div>
            <h3 className="text-xl font-semibold text-white mb-2">Film & Production Work</h3>
            <p className="text-gray-300 mb-1">Email: <a href="mailto:filmwork@actiondriving.com" className="text-blue-400 hover:underline">filmwork@actiondriving.com</a></p>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-2 bg-[#3f4147] text-white rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
            <div>
        ...
        {subscribed ? (
          ...
          <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-2">
            <input
              ...
              required
              className="flex-grow px-4 py-2 bg-[#3f4147] text-white rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            <button
              type="submit"
