  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <section className="bg-[#2f3136] p-8 rounded-lg shadow-lg mb-8">
        <h2 className="text-2xl font-semibold text-white mb-4">Professional Film Production Services</h2>
      ...
      <section className="bg-[#2f3136] p-8 rounded-lg shadow-lg mb-8">
        <h2 className="text-2xl font-semibold text-white mb-4">Stunt Drivers</h2>
        <p className="text-gray-300 mb-4">
      ...
      <section className="bg-[#2f3136] p-8 rounded-lg shadow-lg mb-8">
        <h2 className="text-2xl font-semibold text-white mb-4">Action Design</h2>
        <p className="text-gray-300 mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          <div>
            <h3 className="text-xl font-medium text-white mb-2">Pre-Visualization</h3>
            <p className="text-gray-300 mb-4">
              We provide detailed storyboards, 3D visualizations, and animatics to help you see the sequence before filming begins.
            </p>
          </div>
          <div>
            <h3 className="text-xl font-medium text-white mb-2">Technical Planning</h3>
            <p className="text-gray-300 mb-4">
              Comprehensive planning for camera positions, vehicle modifications, and special equipment needs.
            </p>
          </div>
          <div>
            <h3 className="text-xl font-medium text-white mb-2">Location Scouting</h3>
            <p className="text-gray-300 mb-4">
      ...
      <section className="bg-[#2f3136] p-8 rounded-lg shadow-lg mb-8">
        <h2 className="text-2xl font-semibold text-white mb-4">Stunt Coordination</h2>
        <p className="text-gray-300 mb-4">
      ...
      <section className="bg-[#2f3136] p-8 rounded-lg shadow-lg mb-8">
        <h2 className="text-2xl font-semibold text-white mb-4">Arm Car and Camera Car Driving Experience</h2>
        <p className="text-gray-300 mb-4">
        ...
        <p className="text-gray-300 mb-4">
          Action Driving proudly works with <span className="text-white font-medium">CineTorque</span>, an industry leader in camera 
      ...
      <section className="bg-[#2f3136] p-8 rounded-lg shadow-lg mb-8">
        <h2 className="text-2xl font-semibold text-white mb-4">Vehicle Coordination</h2>
        <p className="text-gray-300 mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          <div>
            <h3 className="text-xl font-medium text-white mb-2">Vehicle Sourcing</h3>
            <p className="text-gray-300 mb-4">
          ...
          <div>
            <h3 className="text-xl font-medium text-white mb-2">Technical Preparation</h3>
            <p className="text-gray-300 mb-4">
              Expert mechanics and fabricators who can modify vehicles for specific stunts and ensure they perform reliably.
            </p>
          </div>
          <div>
            <h3 className="text-xl font-medium text-white mb-2">Transportation Logistics</h3>
            <p className="text-gray-300 mb-4">
              Comprehensive management of vehicle transportation, storage, and on-set handling.
            </p>
          </div>
          <div>
            <h3 className="text-xl font-medium text-white mb-2">Maintenance and Repair</h3>
            <p className="text-gray-300 mb-4">
